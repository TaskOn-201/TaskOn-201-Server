...
import static com.twohundredone.taskonserver.global.enums.ResponseStatusSuccess.GET_TASK_SEARCH_SUCCESS;
...
import com.twohundredone.taskonserver.task.service.TaskSearchService;
...
public class TaskController {
    ...
    public ResponseEntity<ApiResponse<Page<TaskBoardItemDto>>> searchTasks(
        ...
        Page<TaskBoardItemDto> result = taskSearchService.search(
                userDetails.getId(),
                projectId,
                keyword,
                priority,
